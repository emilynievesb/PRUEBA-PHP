...
{
    private $queryPost = 'INSERT INTO pais (nombrePais) VALUES (:nombre_pais)';
    private $queryPut = 'UPDATE pais SET nombrePais = :nombre_pais WHERE  idPais = :id_pais';
    private $queryGetAll = 'SELECT  idPais AS "id_pais", nombrePais AS "nombre_pais" FROM pais';
    private $queryDelete = 'DELETE FROM pais WHERE idPais = :id_pais';
    private $message;

    use getInstance;
    //*Se definen el tipo de dato: static, private, public
    function __construct(private $id_pais = 1, public $nombre_pais = 1)
    {
        parent::__construct();
    ...
    public function post_pais()
    {
        ...
        try {
            ...
            $res->bindValue("nombre_pais", $this->nombre_pais);
    ...
    public function update_pais($id)
    {
        /*Prepare es literalmente preparar el query */
